...
using System;
namespace MyApi.Client.Bookings.V1
{
    /// <summary>
    /// Builds and executes requests for operations under \bookings\v1
    /// </summary>
    ...
    public partial class V1RequestBuilder : BaseRequestBuilder
    {
        ...
        public V1RequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/bookings/v1", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::MyApi.Client.Bookings.V1.V1RequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public V1RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/bookings/v1", rawUrl)
        {
        }
    }
}
